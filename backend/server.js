...
// Adjust contentSecurityPolicy slightly if linking external unsplash images
app.use(
  helmet({
...
// Fallback for HTML routing: redirect arbitrary requests back to index.html if not found (optional)
